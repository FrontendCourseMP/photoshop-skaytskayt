...
interface HistogramViewProps {
  /** Сами значения по бинам. */
  bins: Uint32Array | null;
  /** Глобальный максимум (по всем каналам), чтобы шкалы были сопоставимы. */
  globalMax: number;
  channel: ChannelKey;
...
/**
 * Простая canvas-отрисовка столбцов гистограммы. Один столбец на бин,
 * пиксель в пиксель. Логарифмическая шкала использует log(1 + x), чтобы
 * корректно обрабатывать нули.
 */
